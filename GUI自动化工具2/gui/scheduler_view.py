...
class SchedulerPanel:
    ...
    def _build_ui(self):
        ...
        self.tree.column("id",width=30,minwidth=26,stretch=False,anchor=tk.CENTER)
        self.tree.column("name",width=120,minwidth=60,stretch=True)
        self.tree.column("target",width=80,minwidth=40,stretch=True)
        self.tree.column("schedule",width=80,minwidth=40,stretch=True)
        self.tree.column("next_run",width=100,minwidth=70,stretch=False)
        self.tree.column("last_run",width=100,minwidth=70,stretch=False)
        self.tree.column("status",width=50,minwidth=40,stretch=False,anchor=tk.CENTER)
        self.tree.column("enabled",width=30,minwidth=26,stretch=False,anchor=tk.CENTER)
